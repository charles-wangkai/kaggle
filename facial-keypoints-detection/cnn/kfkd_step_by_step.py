...
# pickle.dump(net1, open('net1.pickle', 'wb'), -1)
...
# valid_loss = pickle.load(open('valid_loss.pkl', 'rb'))
...
pickle.dump(X[:16], open('X.pkl', 'wb'))
pickle.dump(y_pred[:16], open('y_pred.pkl', 'wb'))
...
pickle.dump(sample1, open('sample1.pkl', 'wb'))
pickle.dump(y_pred1, open('y_pred1.pkl', 'wb'))
pickle.dump(y_pred2, open('y_pred2.pkl', 'wb'))


# sample1 = pickle.load(open('sample1.pkl', 'rb'))
# y_pred1 = pickle.load(open('y_pred1.pkl', 'rb'))
# y_pred2 = pickle.load(open('y_pred2.pkl', 'rb'))
...
# plot_sample(sample1[0], y_pred1, ax)
# ax = fig.add_subplot(1, 2, 2, xticks=[], yticks=[])
# plot_sample(sample1[0].reshape(-1, 1, 96, 96)[:, :, :, ::-1], y_pred1, ax)
# pyplot.show()
